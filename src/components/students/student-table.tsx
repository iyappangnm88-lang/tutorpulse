...
import { Eye, Edit2, Archive, Phone, Mail, Layers } from 'lucide-react'
...
export function StudentTable({ students, onArchive, studentBatchesMap = {} }: StudentTableProps) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200 text-left text-sm">
        <thead className="bg-gray-50 font-medium text-gray-600">
          <tr>
            ...
            <th scope="col" className="px-4 py-3.5">Enrolled Batches</th>
        ...
        <tbody className="divide-y divide-gray-100 text-gray-800">
          {students.map((student) => {
            const batches = studentBatchesMap[student.id] || []
            return (
